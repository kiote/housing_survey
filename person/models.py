...
class Person(models.Model):
    ...
    hhfood = models.SmallIntegerField(db_column='HHFOOD', null=True)
    hhmort = models.SmallIntegerField(db_column='HHMORT', null=True)
    hhoth = models.SmallIntegerField(db_column='HHOTH', null=True)
    hhutfu = models.SmallIntegerField(db_column='HHUTFU', null=True)
    ...
    remp = models.SmallIntegerField(db_column='REMP', null=True)
