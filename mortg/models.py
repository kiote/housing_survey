...
class Mortg(models.Model):
    ...
    hecr3 = models.IntegerField(db_column='HECR3', null=True)
    ...
    mcnt = models.PositiveSmallIntegerField(db_column='MCNT', null=True)
    ...
    ramap = models.SmallIntegerField(db_column='RAMAP', null=True)
    ramort = models.SmallIntegerField(db_column='RAMORT', null=True)
