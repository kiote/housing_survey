    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('control', models.IntegerField(null=True, db_column=b'CONTROL')),
                ('jrad', models.SmallIntegerField(null=True, db_column=b'JRAD')),
                ('jras', models.SmallIntegerField(null=True, db_column=b'JRAS')),
                ('rad', models.PositiveIntegerField(null=True, db_column=b'RAD')),
                ('rah', models.PositiveSmallIntegerField(null=True, db_column=b'RAH')),
                ('rahk', models.SmallIntegerField(default=None, null=True, db_column=b'RAHK')),
